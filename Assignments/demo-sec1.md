...
- {Required Slide} Brief description of feature(s) you implemented or your user stories summarized in few words [no more than 1 slide]
- {Required Slide} Status of all conditions of satisfaction for your user stories (summary sentence is fine or even use percentages to show what was implemented vs what was proposed is ok too). Using the table from your project plan may be helpful if a lot of work was not fully completed.
- {Required Slide} Summary of your testing work i.e., coverages for all new features/files [no more than 1 slide].
- {Required Slide} If you did not complete any essential or desirable features, discuss why [no more than 1 slide]
- {Required Slide} Discuss any deviations in work/tasks/priorities (not scheduling or responsibilities) from revised plan, if any. [no more than 1 slide]
...
Poster or Flyer will be worth 1% and will be graded based on whether you submitted it on time or not. 
